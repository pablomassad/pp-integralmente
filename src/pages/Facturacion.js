...
export default function Facturacion()
{
    ...
    const genVersionsChart = () =>
    {
        d3.select('.versions').remove()
        ...
        const svg = svgGlobal.append('g').attr('class', 'versions')
    ...
    return (
        <FacturacionFrame ref={wrapperRef}>
            <Chart ref={svgRef} />
        </FacturacionFrame>
    )
}
...
const VersionsFrame = styled.div`
	--class: VersionsFrame;
`
