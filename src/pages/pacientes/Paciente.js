...
export default function Paciente()
{
    ...
    return (
        <PatientFrame>
            <Toolbar>
                <Tool onClick={() => setSelTool('ficha')} active={selTool === 'ficha'}>
                    <IconFicha active={selTool === 'ficha'} />
                    Ficha
                </Tool>
                <Tool onClick={() => setSelTool('historia')} active={selTool === 'historia'}>
                    <IconHistoria active={selTool === 'historia'}/>
                    Historia
                </Tool>
                <Tool onClick={() => setSelTool('documentacion')} active={selTool === 'documentacion'}>
                    <IconDocumentacion active={selTool === 'documentacion'}/>
                    Documentación
                </Tool>
                <Tool onClick={() => setSelTool('facturas')} active={selTool === 'facturas'}>
                    <IconFacturas active={selTool === 'facturas'}/>
                    Facturas
                </Tool>
            </Toolbar>
            {(selTool === 'ficha') && (
